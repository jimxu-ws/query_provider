...
final createPostMutationProvider = createProvider<Post, Map<String, dynamic>>(
  name: 'create-post',
  mutationFn: (ref, variables) => ApiService.createPost(variables),
...
final updatePostMutationProvider = updateProviderWithParams<Post, Map<String, dynamic>, int>(
  ...
  onSuccess: (ref, post, variables, postId) {
  ...
  onError: (ref, variables, postId, error, stackTrace) {
...
final deletePostMutationProvider = deleteProviderWithParams<void, int>(
  ...
  onError: (ref, postId, error, stackTrace) {
